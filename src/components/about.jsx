      ...
      <div className="py-[120px] px-[20px] xl:px-[80px] flex flex-wrap gap-[20px] justify-between">
        ...
        <p
          className="
            ...
            text-[16px] xl:text-[20px] leading-[1] text-[rgb(var(--fg))] relative
          "
        >
        ...
        >
          ...
          transformation, we turn your vision into a durable, stylish reality. We listen, plan, and
          deliver — with attention to detail and commitment to quality.
        </p>
